...
Jeweler.trade = {
	...
	-- Sellable jewels
	--{'gold ingot', 	 			id=????, buy=5000};
	{'giant shimmering pearl',  id=7632, buy=3000};
	{'giant shimmeting pearl', 	id=7633, buy=3000};
	--{'blue crystal shard',  	id=????, buy=1500};
	--{'green crystal shard',	    id=????, buy=1500};
	--{'violet crystal shard',    id=????, buy=1500};
	--{'cyan crystal fragment', 	id=????, buy=800};
	--{'greent crystal fragment', id=????, buy=800};
	--{'red crystal fragment',    id=????, buy=800};
	--{'blue crystal splinter', 	id=????, buy=400};
	--{'brown crystal splinter', 	id=????, buy=400};
	--{'green crystal splinter',  id=????, buy=400};
	{'small diamond', 	 		id=2145, buy=300};
	{'black pearl',  	 		id=2144, buy=280};
	{'small emerald', 	 		id=2149, buy=250};
	{'small ruby', 	 	 		id=2147, buy=250};
	{'small sapphire', 	 		id=2146, buy=250};
	{'small amethyst', 	 		id=2150, buy=200};
	{'small topaz', 	 	    id=9970, buy=200};
	{'white pearl', 	 		id=2143, buy=160};
	{'wedding ring', 	 		id=2121, buy=100};
